...
class ShopIntegrationTest {
    ...
    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper().registerModule(
        new JavaTimeModule());
    public static final String SHOP_REGISTRATION_URI = "/v1/shops";
    ...
    void dataInsertedRelevanceWithShopAndGet200OKIfShopRegistrationRequestSucceed()
        ...
        ResultActions resultActions = mockMvc.perform(
            MockMvcRequestBuilders.post(SHOP_REGISTRATION_URI).contentType(MediaType.APPLICATION_JSON)
    ...
    void getErrorResponseMessageIfFindShopLikstFailed() throws Exception {
