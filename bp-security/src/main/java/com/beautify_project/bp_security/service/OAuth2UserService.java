package com.beautify_project.bp_security.service;
...
public class OAuth2UserService extends DefaultOAuth2UserService {
    ...
    public MemberAdapter createNewThirdPartyAuthMember(final String email, AuthType authType) {
        return MemberAdapter.createNewMemberAdapter(email, EncryptionUtils.encodeBCrypt(DEFAULT_PASSWORD), null, null,
