package com.beautify_project.bp_mysql.entity.embedded;
...
public class Address {
    ...
    public static Address of(final String dongCode, final String siDoName,
        final String siGoonGooName, final String eubMyunDongName, final String roadNameCode,
        final String roadName, final String underGround, final String roadMainNum,
        final String roadSubNum, final String siGoonGooBuildingName, final String zipCode,
        final String apartComplex, final String eubMyunDongSerialNumber, final String latitude,
        final String longitude) {

        return new Address(dongCode, siDoName, siGoonGooName, eubMyunDongName, roadNameCode,
            roadName, underGround, roadMainNum, roadSubNum, siGoonGooBuildingName, zipCode,
            apartComplex, eubMyunDongSerialNumber, latitude, longitude);
    }
